...
1. Person_Lab5.hpp depicts the use of overloading the boolean (==) operator and the ostream (<<) operator, as well as friend functions.
...
4. AccountManager depicts the use of overloading the constructor function as you can construct an object with an object of type Person
or BankAccount.
